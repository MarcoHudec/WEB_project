                        ...
                        <div class="row g-0">
                            <div class="col-lg-6">
                                <div class="card-body p-md-5 mx-md-4">
                                    ...
                                    <form id="registrationForm" action="logic/validate.php" method="post">
                                    ...
                                    <?php require("logic/validate.php")?>
                                        ...
                                        <div class="form-outline mb-4">
                                            ...
                                            <select name="salutation" id="gender" class="form-select" required>
                                        ...
                                        <div class="form-outline mb-4">
                                            ...
                                            <input type="text" name="firstName" id="fname" class="form-control <?php echo $fname_valid?>" <?php echo 'value="'.$fname.'"' ?> placeholder="First Name" required />
                                            <div class="invalid-feedback" <?php echo $fname_error ?>></div>
                                        </div>

                                        <div class="form-outline mb-4">
                                            <label class="form-label" for="lname">Last Name</label>
                                            <input type="text" name="lastName" id="lname" class="form-control <?php echo $lname_valid?>" <?php echo 'value="'.$lname.'"' ?> placeholder="Last Name" required />
                                            <div class="invalid-feedback" <?php echo $lname_error ?>></div>
                                        </div>

                                        <div class="form-outline mb-4">
                                            <label class="form-label" for="mail">E-Mail-Adress</label>
                                            <input type="email" name="email" id="mail" class="form-control <?php echo $mail_valid?>" <?php echo 'value="'.$mail.'"' ?> placeholder="E-Mail-Adress" required />
                                        ...
                                        <div class="form-outline mb-4">
                                            ...
                                            <input type="text" name="uname" id="uname" class="form-control <?php echo $uname_valid?>" <?php echo 'value="'.$uname.'"' ?> placeholder="Username" required />
                                        ...
                                        <div class="form-outline mb-4">
                                            ...
                                            <input type="password" name="password" id="pw" class="form-control <?php echo $pw_valid?>" <?php echo 'value="'.$pw.'"' ?> placeholder="Password" required />
                                            <div class="invalid-feedback" <?php echo $pw_error ?>></div>
                                        </div>

                                        <div class="form-outline mb-4">
                                            <label class="form-label" for="re_pw">Confirm Password</label>
                                            <input type="password" name="confirmPassword" id="re_pw" class="form-control <?php echo $re_pw_valid?>" <?php echo 'value="'.$fname.'"' ?> placeholder="Password" required />
