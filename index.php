...
<head>
    <?php include("includes/head.php")?> <!-- Include common head elements -->
    <meta charset="utf-8" />
...
<body>
    ...
    <!-- Carousel for showcasing hotel images -->
    ...
    <section >
        ...
        <!-- Section for showcasing hotel rooms -->
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <div class="card mb-4">
 ...
 <!-- Section for showcasing hotel facilities -->
    <section>
...
<?php include("includes/scripts.php")?> <!-- Include common scripts -->
</html>
